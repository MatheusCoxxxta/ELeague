...
<body>
   ...
   <table id="tabelaPrincipal" border=1>
    ...
    <thead> 
      <tr>
      <td id='tamColuna1'> <b id='colNomeEvento'> Codigo da Equipe </td>
...
if(isset($_POST["buscaIdEquipe"])) $buscaIdEquipe=$_POST["buscaIdEquipe"];
	else $buscaIdEquipe = "";
	$codEquipe = $_GET['codEquipe'];
			...
			echo "<td><b id='col1'><font color='#0b2e59'> <input type='hidden' name='codEquipe' value='". $codEquipe ." '> ". $codEquipe ." </td>";
			//campo de texto permite que o usuário veja o nome atual e digite um novo nome para a equipe
			echo "<td><font color='#0b2e59'> <input class='editarEquipe' type='text' name='novoJogador'> </td>";
 ...
 ?>
   <input type="submit" id="btnBusca" name="submit" value="Adicionar!" onclick='eventoAdicionado();'>
