...
<head>
    ...
    <link rel="stylesheet" href="css/StyleNovosConfrontos10.css">
...
<body>
	...
	<div id="divPrincipal"> 
		...
		<form action="gerandoConfrontos10.php" method="POST"> 
<?php
    ...
    if($sql -> execute())
    {
		...
		{ 
			...
			while ($campo = $sql -> fetch (PDO::FETCH_OBJ)) 
			{
				...
				echo "<input type='text' class='equipe' name='Equipe".$col."' value=' ". $campo -> nomeEquipe ."' readonly>";
				echo "<input type='text' class='codEquipe' name='codEquipe".$col."' value=' ". $campo -> codEquipe ."' readonly>";
