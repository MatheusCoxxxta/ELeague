...
<head>
    ...
    <link rel="stylesheet" href="Fixed-Header--Footer--Scrolling-Body-Content1.css">
    ...
    <div id="wrapper" style="position:absolute;top:0;z-index:999;">
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
				...
				<a href="#">Boletim</a></li>
				<li> <a href="Novo Campeonato.html">Adicionar Campeonato</a>
            </ul>
        </div>
   ...
   if($sql -> execute()){ // sucesso ao executar sql?
	if ($sql -> rowCount() > 0){ // há informações?	   
		...
		while ($campo = $sql -> fetch (PDO::FETCH_OBJ)){// percorre consulta
			...
			echo "<b><font color='#0b2e59'>". $campo -> nomeCamp ."<br>";
			echo "<b><font color='#0b2e59'> Equipes: ". $campo -> QuantEquipe ."";
			echo "<b><font color='#0b2e59'> Jogadores: ". $campo -> jogEquipe ."<br>";
